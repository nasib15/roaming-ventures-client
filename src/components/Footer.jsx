...
const Footer = () => {
  return (
    <div className="px-4 mt-24 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          <div className="mt-6 lg:max-w-sm">
            ...
            <p className="mt-4 text-sm text-gray-800">
              Explore captivating destinations, uncover hidden gems, and let our
              expert guidance ignite your wanderlust. Begin your next
        ...
        <div>
          ...
          <p className="mt-4 text-sm text-gray-500">
            Connect with us on social media for travel inspiration, updates, and
            exclusive offers. Follow us on Facebook, Twitter, YouTube, and
